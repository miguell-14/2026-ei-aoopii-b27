...
- Comprimento da manga (sleeveless, short, medium, long)
- Tipo de tecido (denim, cotton, leather, furry, knitted, chiffon, other)
- Padrão de cor (floral, graphic, striped, pure color, lattice, other, color block)
...
| 06 — Improved Training | Treino melhorado com focal loss | Em progresso |
